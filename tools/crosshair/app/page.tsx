...
import { rawSignals, insights, clusters, actionItems } from '@/db/schema';
...
export default async function Home() {
  ...
  const pendingActionsCount = await db.$count(actionItems, eq(actionItems.status, 'pending'));
  ...
  return (
    <main className="min-h-screen p-8 max-w-7xl mx-auto">
      ...
      <div className="mt-12">
        <h2 className="text-2xl font-semibold mb-4">All Clusters ({totalClustersCount})</h2>

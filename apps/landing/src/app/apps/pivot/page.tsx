  ...
  return (
    <div className="container section-padding max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-lg text-muted-foreground">
        <Trans>PIVOT combines docs, relational databases, and instant search. Your project data lives natively alongside your CRM and inventory. No per‑user fees. No trapped data.</Trans>
      </p>
          ...
          <div className="overflow-x-auto"><table className="w-full text-sm border-collapse">
            ...
            <tbody>
              <tr className="border-b border-border/50">
                <td className="py-2 text-muted-foreground"><Trans>$18/user/mo</Trans></td>
      ...
      <div className="mt-12 p-6 rounded-lg border border-primary/30 bg-card/50">
        ...
        <p className="mt-2 text-muted-foreground">
          <Trans>PIVOT tasks can be application‑level linked to CINQ deals and VAULT products. When a deal closes, the associated PIVOT task auto‑updates. No Zapier required.</Trans>
        </p>
      </div>

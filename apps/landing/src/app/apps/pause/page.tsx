	...
	return (
		<div className="container section-padding max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
			...
			<p className="mt-4 text-lg text-muted-foreground">
				<Trans>
					PAUSE handles employee onboarding, leave requests, and approvals —
					natively connected to AEGIS and TEMPO. No payroll complexity. Just
					essential HR with native security.
				</Trans>
			</p>
			...
			<div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
				<div className="p-6 rounded-lg border border-border bg-card/30 overflow-x-auto">
					...
					<ul className="mt-4 space-y-2 text-muted-foreground">
						<li>
							• <Trans>Employee directory (searchable)</Trans>
						</li>
						<li>
							• <Trans>Leave requests & approvals (3 clicks)</Trans>
						</li>
						<li>
							• <Trans>Centralized documents (contracts, payslips)</Trans>
						</li>
						<li>
							• <Trans>Onboarding workflows</Trans>
						</li>
						<li>
							• <Trans>Native AEGIS deprovisioning</Trans>
						</li>
						<li>
							• <Trans>TEMPO calendar integration</Trans>
						</li>
					</ul>
				</div>
					...
					<div className="overflow-x-auto">
						<table className="w-full text-sm border-collapse">
							...
							<tbody>
								...
								<tr className="border-b border-border/50">
									<td className="py-2 text-muted-foreground">
										<Trans>No native AEGIS integration</Trans>
									</td>
									<td className="py-2 text-primary font-bold">
										<Trans>Auto‑deprovisioning via AEGIS</Trans>
									</td>
								</tr>
								<tr className="border-b border-border/50">
									<td className="py-2 text-muted-foreground">
										<Trans>Support degrades after signing</Trans>
									</td>
									<td className="py-2 text-primary font-bold">
								...
								<tr>
									<td className="py-2 text-muted-foreground">
										<Trans>Lock‑in: difficult to cancel</Trans>
									</td>
									<td className="py-2 text-primary font-bold">
										<Trans>1‑click cancel & export</Trans>
									</td>
								</tr>
							</tbody>
						</table>
			...
			<div className="mt-12 p-6 rounded-lg border border-primary/30 bg-card/50">
				...
				<p className="mt-2 text-muted-foreground">
					<Trans>
						When an employee is offboarded in PAUSE, AEGIS instantly revokes
						access to all apps. When leave is approved, TEMPO blocks the

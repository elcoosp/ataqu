  ...
  return (
    <div className="container section-padding max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <p className="mt-4 text-lg text-muted-foreground">
        <Trans>AEGIS provides SSO, MFA, and RBAC — natively integrated with PAUSE and all 10 apps. No per‑user fees. No separate identity product. Just native security.</Trans>
      </p>
      ...
      <div className="mt-12 p-6 rounded-lg border border-primary/30 bg-card/50">
        ...
        <p className="mt-2 text-muted-foreground">
          <Trans>AEGIS is woven into the source code of Ataqu. When an employee is offboarded in PAUSE, AEGIS instantly revokes their access to all 10 apps. No manual deprovisioning.</Trans>
        </p>
      </div>
      ...
      <div className="mt-12">
        ...
        <p className="mt-2 text-center text-muted-foreground">
          <Trans>Start with AEGIS for $15/mo (or get all 10 for $79/mo). No credit card required for the trial.</Trans>
        </p>
        <div className="mt-6">
          <WaitlistForm />
        </div>

			...
			<div className="grid grid-cols-1 md:grid-cols-3 gap-6">
				<div className="p-6 rounded-lg border border-border bg-card/30">
					...
					<p className="text-sm text-muted-foreground mt-1">
						Monolithic, modular, and compiled to native code. No microservices,
						no overhead.
					</p>
				</div>
				<div className="p-6 rounded-lg border border-border bg-card/30">
					...
					<p className="text-sm text-muted-foreground mt-1">
						MVCC, JSONB, schemas, and a unified outbox with LISTEN/NOTIFY for
						instant events.
					</p>
				</div>
				<div className="p-6 rounded-lg border border-border bg-card/30">
					...
					<p className="text-sm text-muted-foreground mt-1">
						PII redacted at compile time; JSON serialization isolated to the API
						layer.
					</p>
				</div>
			</div>
			...
			<div className="p-6 rounded-lg border border-border bg-card/20">
				...
				<div className="flex flex-col items-center space-y-4">
					<div className="flex flex-wrap justify-center gap-2">
						<span className="px-3 py-1 rounded-full border border-border bg-card/40 text-xs font-mono">
							10 SPAs
						</span>
						...
						<ArrowRight className="w-4 h-4 text-muted-foreground" />
						<span className="px-3 py-1 rounded-full border border-primary/30 bg-primary/10 text-xs font-mono text-primary">
							Unified Outbox
						</span>
						<ArrowRight className="w-4 h-4 text-muted-foreground" />
						<span className="px-3 py-1 rounded-full border border-border bg-card/40 text-xs font-mono">
					...
					<div className="text-xs text-muted-foreground text-center">
						Single database, unified outbox with LISTEN/NOTIFY – instant
						cross‑app events
					</div>
				</div>
			</div>

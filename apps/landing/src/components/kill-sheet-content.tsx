...
function getCompetitorData(slug: string) {
	const data: Record<string, any> = {
		hubspot: {
			name: t`HubSpot`,
			tagline: t`HubSpot charges $1,200/mo for reporting. Ataqu includes it natively — start at $15/mo, or get all 10 for $79/mo.`,
			tcoRows: [
				{
					name: "HubSpot",
					price: "$800/mo",
					contract: "3‑year lock‑in",
					note: "Professional tier",
					highlight: false,
				},
				{
				...
				},
				{
					...
					note: "All 10 apps (also $15/mo for 1)",
					highlight: true,
				},
			],
			painPoints: [
		...
		slack: {
			name: t`Slack`,
			tagline: t`Slack taxes your team. DIAL gives you chat and support — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Slack",
					price: "$12.50/user/mo",
					contract: "Monthly",
					note: "$250/mo for 20 users",
					highlight: false,
				},
				{
		...
		zapier: {
			name: t`Zapier`,
			tagline: t`Zapier is a brittle bridge. SPARK is the native foundation — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Zapier",
					price: "$49/mo",
					contract: "Monthly",
					note: "2,000 tasks/mo limit",
					highlight: false,
				},
				{
		...
		notion: {
			name: t`Notion`,
			tagline: t`Notion is a blank canvas graveyard. PIVOT is an operational database — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Notion",
					price: "$18/user/mo",
					contract: "Monthly",
					note: "$360/mo for 20 users",
					highlight: false,
				},
				{
					name: "Zapier (integration)",
		...
		"zoho-one": {
			name: t`Zoho One`,
			tagline: t`Zoho One is bloatware disguised as a suite. Ataqu is 10 exceptional apps — from $15/mo, or all 10 for $79/mo.`,
			tcoRows: [
				{
					name: "Zoho One",
					price: "$37/user/mo",
					contract: "Annual",
					note: "$740/mo for 20 users",
					highlight: false,
				},
				{
					name: "Integrations",
		...
		calendly: {
			name: t`Calendly`,
			tagline: t`Calendly is a scheduling island. TEMPO is built into your OS — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Calendly",
					price: "$20/seat/mo",
					contract: "Monthly",
					note: "$200/mo for 10 seats",
					highlight: false,
				},
				{
		...
		typeform: {
			name: t`Typeform`,
			tagline: t`Typeform charges for success. SOND gives you unlimited responses — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Typeform",
					price: "$50/mo",
					contract: "Monthly",
					note: "1,000 responses/mo",
					highlight: false,
				},
				{
		...
		cin7: {
			name: t`Cin7`,
			tagline: t`Cin7 is a siloed warehouse. VAULT connects inventory to your CRM — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Cin7 Core",
					price: "$349/mo",
					contract: "Annual",
					note: "5 users included",
					highlight: false,
				},
				{
		...
		personio: {
			name: t`Personio`,
			tagline: t`Personio is a compliance silo. PAUSE connects HR to operations — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Personio Essentials",
					price: "$10/user/mo",
					contract: "Annual",
					note: "$200/mo for 20 users",
					highlight: false,
				},
				{
					name: "AEGIS (deprovision)",
					price: "$15/user/mo",
					contract: "Annual",
					note: "Separate SSO",
					highlight: false,
		...
		okta: {
			name: t`Okta`,
			tagline: t`Okta is a gatekeeper standing on top of your stack. AEGIS is the vault built into the foundation — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Okta Lifecycle Mgmt",
					price: "$8/user/mo",
					contract: "Annual",
					note: "$160/mo for 20 users",
					highlight: false,
				},
				{
					name: "HR integration",
		...
		tableau: {
			name: t`Tableau`,
			tagline: t`Tableau is an ETL nightmare. VISTA is real‑time analytics, natively connected to your data — from $15/mo, or all 10 apps for $79/mo.`,
			tcoRows: [
				{
					name: "Tableau Explorer",
					price: "$42/user/mo",
					contract: "Annual",
					note: "$840/mo for 20 users",
					highlight: false,
				},
				{
					name: "ETL pipeline",
			...
			<div className="max-w-4xl mx-auto">
						...
						<table className="w-full border-collapse">
							...
							<tbody>
								{tcoRows.map((row: any, idx: number) => (
									...
									>
										<td
											className={`py-3 px-4 font-display text-sm ${row.highlight ? "text-primary font-bold" : "text-foreground"}`}
										>
											{row.name}
										</td>
										<td
											className={`py-3 px-4 font-mono text-sm ${row.highlight ? "text-primary" : "text-foreground"}`}
										>
											{row.price}
										</td>
				...
				<section id="waitlist" className="mt-12">
					...
					<p className="mt-2 text-center text-muted-foreground">
						<Trans>
							Be first to access the suite. No credit card required.
						</Trans>
					</p>
					<div className="mt-6">
						<WaitlistForm />

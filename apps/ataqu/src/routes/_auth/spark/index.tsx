...
import { useListWorkflows } from "../../../apps/spark/api/spark-api";
import { WorkflowList } from "../../../apps/spark/components/workflow-list";

export const Route = createFileRoute("/_auth/spark/")({
			...
			<div className="flex items-center justify-between">
				<div>
					...
					<p className="text-sm text-muted-foreground mt-1">
						<Trans>
							Native automation triggers and actions. Zero per-task fees.
						</Trans>
					</p>
				</div>

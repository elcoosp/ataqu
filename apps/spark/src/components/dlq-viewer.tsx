          ...
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-mono text-muted-foreground">{entry.event_type}</span>
              ...
              <div className="mb-2">
                <label className="text-xs text-muted-foreground block mb-0.5"><Trans>Error</Trans></label>
                <p className="text-sm text-red-400 font-mono break-all">{entry.error}</p>
              </div>

              <div>
                <label className="text-xs text-muted-foreground block mb-0.5"><Trans>Payload</Trans></label>
              ...
              <div className="text-xs text-muted-foreground mt-2">
                <Trans>Created:</Trans> {new Date(entry.created_at).toLocaleString()}
              </div>
            </div>

	...
	return (
		<div className={`flex items-center gap-3 ${className}`}>
			<div
				...
				className="min-w-0 flex-1 rounded-[4px] bg-background p-[2px] shadow-[inset_0_1px_2px_rgba(28,25,23,0.07)] dark:bg-card dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.45)]"
			>
				<motion.div
					className="h-[3px] origin-left rounded-[2px] bg-[var(--ring)] dark:bg-[var(--ring)]"
					style={{ width: "100%" }}
					initial={false}
			...
			{estimate ? (
				<div className="grid shrink-0 justify-items-end font-mono text-[10.5px] tabular-nums">
					...
					<motion.span
						aria-hidden
						className="col-start-1 row-start-1 whitespace-nowrap text-muted-foreground dark:text-muted-foreground"
						initial={false}
					...
					<motion.span
						aria-hidden
						className="col-start-1 row-start-1 flex items-center gap-1 whitespace-nowrap text-secondary-foreground dark:text-secondary-foreground"
						initial={false}

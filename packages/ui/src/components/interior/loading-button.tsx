	...
	const faces = [
		{
			key: "idle",
			text: children,
			tone: "text-secondary-foreground dark:text-secondary-foreground",
			icon: null,
		},
		{
			key: "pending",
			text: pendingLabel,
			tone: "text-muted-foreground dark:text-muted-foreground",
	...
	return (
		<>
			<motion.button
				...
				className={`relative inline-flex h-9 select-none items-center justify-center rounded-[9px] border border-border bg-white px-3.5 text-[13px] font-medium text-secondary-foreground shadow-[inset_0_1.5px_0_rgba(255,255,255,0.95),inset_0_-1px_0_rgba(28,25,23,0.06),0_1px_2px_rgba(28,25,23,0.08)] outline-none transition-[border-color,box-shadow,background-color] duration-150 hover:bg-background focus-visible:border-[var(--ring)] focus-visible:shadow-[0_1px_2px_rgba(28,25,23,0.08),0_10px_20px_-14px_rgba(69,104,255,0.6)] disabled:opacity-50 dark:border-white/[0.16] dark:bg-muted dark:text-secondary-foreground dark:shadow-[inset_0_1px_0_rgba(255,255,255,0.07),0_1px_2px_rgba(0,0,0,0.4)] dark:hover:bg-accent dark:focus-visible:border-[var(--ring)] dark:focus-visible:shadow-[0_10px_20px_-14px_rgba(147,176,255,0.5)] ${className}`}

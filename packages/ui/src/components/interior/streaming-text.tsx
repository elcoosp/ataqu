...
export function StreamingText({
	...
	const caret = (
		...
		>
			<motion.span
				className="absolute inset-y-0 left-px block w-[2px] bg-card dark:bg-background"
				initial={false}
			...
			{showSkip ? (
				<div className="mt-2.5 flex justify-end">
					<button
						...
						className="inline-grid h-7 place-items-center rounded-[6px] border border-border px-2.5 text-[11.5px] font-medium text-muted-foreground transition-colors duration-150 hover:text-secondary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-stone-400 dark:border-white/[0.16] dark:text-muted-foreground dark:hover:text-secondary-foreground dark:focus-visible:ring-stone-500"
					>
						<motion.span
							aria-hidden

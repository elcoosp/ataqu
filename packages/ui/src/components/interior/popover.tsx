				...
				{open ? (
					...
					>
						<motion.div
							...
							className={`relative rounded-[11px] border border-border bg-white p-3 shadow-[0_18px_40px_-24px_rgba(28,25,23,0.5)] focus-visible:outline-none dark:border-white/[0.16] dark:bg-card dark:shadow-[0_18px_40px_-24px_rgba(0,0,0,0.9)] ${className}`}
						>
							<span
								ref={arrowRef}
								aria-hidden
								...
								className={`absolute block bg-white dark:bg-card border-border dark:border-white/[0.16] ${ARROW_EDGE[at]}`}
							/>
							<div
								ref={contentRef}

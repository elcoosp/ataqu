...
export function Accordion({
	...
	return (
		<div
			className={`divide-y divide-stone-200 overflow-hidden rounded-[11px] border border-border bg-white shadow-[0_1px_2px_rgba(28,25,23,0.06),0_4px_10px_-8px_rgba(28,25,23,0.45)] dark:divide-white/10 dark:border-white/[0.16] dark:bg-card dark:shadow-[0_1px_6px_rgba(0,0,0,0.45)] ${className}`}
		>
			{items.map((item) => (
				<AccordionRow
					key={item.id}
	...
	return (
		<div>
			<div role="heading" aria-level={headingLevel}>
				<button
					{...header}
					className="flex w-full items-center gap-3 px-3.5 py-3 text-left outline-none transition-colors duration-150 hover:bg-background focus-visible:bg-[var(--ring)]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--ring)] dark:hover:bg-white/10 dark:focus-visible:bg-[var(--ring)]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_var(--ring)]"
				>
					<span
					...
					{item.meta ? (
						<span className="shrink-0 text-[11.5px] tabular-nums text-muted-foreground dark:text-muted-foreground">
							{item.meta}
						</span>
					) : null}
			...
			>
				<div
					{...panel}
					ref={ref}
					className="border-t border-border bg-background shadow-[inset_0_1px_2px_rgba(28,25,23,0.05)] dark:border-white/[0.16] dark:bg-white/[0.05] dark:shadow-[inset_0_1px_2px_rgba(0,0,0,0.3)]"
					style={{
				...
				>
					<motion.div
						...
						className="px-3.5 pb-3.5 pt-3 text-[12.5px] leading-relaxed text-muted-foreground dark:text-muted-foreground"
					>
						{item.content}
					</motion.div>
				</div>

...
const TONE: Record<LoadMoreStatus, string> = {
	idle: "text-secondary-foreground dark:text-secondary-foreground",
	loading: "text-muted-foreground dark:text-muted-foreground",
	error: "text-destructive dark:text-destructive",
	end: "text-muted-foreground dark:text-muted-foreground",
};
	...
	return (
		<div className={`relative flex w-full justify-center ${className}`}>
			...
			<button
				...
				className={`group relative inline-flex h-8 select-none items-center justify-center rounded-[9px] px-3 text-[12.5px] font-medium outline-none transition-[background-color,box-shadow,transform] duration-150 focus-visible:bg-[var(--ring)]/[0.06] focus-visible:shadow-[inset_0_0_0_1px_var(--ring)] dark:focus-visible:bg-[var(--ring)]/[0.1] dark:focus-visible:shadow-[inset_0_0_0_1px_var(--ring)] ${
					inert
						? "cursor-default"
						: "cursor-pointer hover:bg-card/[0.04] active:translate-y-px dark:hover:bg-white/[0.06]"
				}`}

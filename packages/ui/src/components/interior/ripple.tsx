...
export function Ripple({
	...
	disabled = false,
	max = 4,
	tintClassName = "bg-card/15 dark:bg-white/20",
	className = "",
}: RippleProps) {
	...
	return (
		<button
			...
			className={`relative isolate inline-flex select-none items-center justify-center gap-2 rounded-[9px] border border-border bg-white px-3.5 py-2 text-[13px] font-medium text-secondary-foreground outline-none focus-visible:ring-2 focus-visible:ring-stone-400 disabled:opacity-50 dark:border-white/[0.16] dark:bg-card dark:text-secondary-foreground dark:focus-visible:ring-white/25 ${className}`}
			{...bind}
		>
			<span
				aria-hidden

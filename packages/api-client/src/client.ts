...
export const api = {
  ...
  post: <T>(path: string, data?: any, options?: RequestOptions): Promise<T> => request<T>(path, { ...options, method: 'POST', body: data }),
  put: <T>(path: string, data?: any, options?: RequestOptions): Promise<T> => request<T>(path, { ...options, method: 'PUT', body: data }),
  patch: <T>(path: string, data?: any, options?: RequestOptions): Promise<T> => request<T>(path, { ...options, method: 'PATCH', body: data }),

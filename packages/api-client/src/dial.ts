...
export const getOnlineUsers = () =>
	api.get<{ online_users: UUID[] }>("/dial/presence/online");
...
export const exportChannelPdf = (channelId: UUID) =>
	api.get<Blob>(`/dial/channels/${channelId}/export/pdf`, {
		responseType: "blob",
	});
...
export const useGetThread = (id: UUID, options?: UseQueryOptions<Thread>) =>
	useQuery({
		queryKey: ["dial", "thread", id],
		queryFn: () => getThread(id),
		...options,
	});
export const useListThreadMessages = (
	threadId: UUID,
	params?: { limit?: number; offset?: number },
...
export const useListMentions = (
	options?: UseQueryOptions<{ mentions: Mention[] }>,
) =>
	useQuery({
		queryKey: ["dial", "mentions"],
		queryFn: listMentions,
		...options,
	});
export const useListReactions = (
	messageId: UUID,
	options?: UseQueryOptions<Reaction[]>,
) =>
	useQuery({
...
export const useSearchMessages = (
	...
	options?: UseQueryOptions<{ messages: Message[] }>,
) =>
	useQuery({
...
export const useSendMessage = (
	options?: UseMutationOptions<
		Message,
		Error,
		{ channelId: UUID; data: SendMessageRequest }
	>,
) =>
	useMutation({
...
export const useStartThread = (
	options?: UseMutationOptions<Thread, Error, StartThreadRequest>,
...
export const useAddReaction = (
	options?: UseMutationOptions<
		Reaction,
		Error,
		{ messageId: UUID; data: AddReactionRequest }
	>,
) =>
	useMutation({
...
export const useDeleteReaction = (
	options?: UseMutationOptions<
		void,
		Error,
		{ messageId: UUID; reactionId: UUID }
	>,
) =>
	useMutation({
...
export const useUploadFile = (
	options?: UseMutationOptions<
		UploadFileResponse,
		Error,
		{ channelId: UUID; data: UploadFileRequest }
	>,
) =>
	useMutation({

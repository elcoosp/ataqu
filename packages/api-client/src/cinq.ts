...
export const searchByCustomField = (field: string, value: string) =>
	api.get<ContactResponse[]>("/cinq/search/custom", {
		params: { field, value },
	});
export const searchCustomFieldsCross = (params: {
	q: string;
	limit?: number;
...
export const getContactTracking = (
	contactId: UUID,
	params?: { limit?: number; offset?: number },
) =>
...
export const useGetDeal = (id: UUID, options?: UseQueryOptions<DealResponse>) =>
	useQuery({
		queryKey: ["cinq", "deal", id],
		queryFn: () => getDeal(id),
		...options,
	});
export const useListPipelineStages = (
	options?: UseQueryOptions<PipelineStageResponse[]>,
) =>
	useQuery({
		queryKey: ["cinq", "pipeline"],
...
export const useGetActivity = (
	...
	useQuery({
		queryKey: ["cinq", "activity", id],
		queryFn: () => getActivity(id),
		...options,
	});
export const useListTasks = (
	params?: { limit?: number; offset?: number },
	options?: UseQueryOptions<TaskResponse[]>,
) =>
	useQuery({
		queryKey: ["cinq", "tasks", params],
		queryFn: () => listTasks(params),
		...options,
	});
export const useGetTask = (id: UUID, options?: UseQueryOptions<TaskResponse>) =>
	useQuery({
		queryKey: ["cinq", "task", id],
		queryFn: () => getTask(id),
		...options,
	});
export const useListContactTasks = (
	contactId: UUID,
	params?: { limit?: number; offset?: number },
	options?: UseQueryOptions<TaskResponse[]>,
) =>
...
export const useSearchByCustomField = (
	field: string,
	value: string,
	options?: UseQueryOptions<ContactResponse[]>,
) =>
...
export const useSearchCustomFieldsCross = (
...
export const useCreateDeal = (
	options?: UseMutationOptions<DealResponse, Error, CreateDealRequest>,
...
export const useCreateActivity = (
	options?: UseMutationOptions<ActivityResponse, Error, CreateActivityRequest>,
) => useMutation({ mutationFn: createActivity, ...options });

export const useCreateTask = (
	options?: UseMutationOptions<TaskResponse, Error, CreateTaskRequest>,
...
export const useImportCsv = (
	options?: UseMutationOptions<ImportCsvResult, Error, FormData>,
...
export const useTrackEmail = (
	options?: UseMutationOptions<void, Error, TrackEmailRequest>,
) => useMutation({ mutationFn: trackEmail, ...options });
export const useGetContactTracking = (
	contactId: UUID,
	params?: { limit?: number; offset?: number },
	options?: UseQueryOptions<{ items: any[]; total: number }>,
) =>
	useQuery({

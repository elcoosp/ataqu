...
// ---- Dashboards ----
export const listDashboards = () => api.get<Dashboard[]>("/vista/dashboards");
...
export const useGetDataPoints = (
	metric: string,
	params?: { limit?: number },
	options?: UseQueryOptions<DataPoint[]>,
) =>
	useQuery({
...
export const useGetCrossAppView = (
	params: CrossAppQuery,
...
export const useCreateDashboard = (
	options?: UseMutationOptions<Dashboard, Error, CreateDashboardRequest>,

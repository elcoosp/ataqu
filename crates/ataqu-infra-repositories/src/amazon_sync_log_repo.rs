//! Repository for Amazon sync logs (mirrors Shopify's sync log repo).
use sea_orm::{DatabaseConnection, EntityTrait, IntoActiveModel, Set};
use uuid::Uuid;

use ataqu_kernel::TenantId;

mod amazon_sync_log_entity {
    use chrono::{DateTime, Utc};
    use sea_orm::entity::prelude::*;
    use uuid::Uuid;

    #[derive(Clone, Debug, PartialEq, DeriveEntityModel, Eq)]
    #[sea_orm(table_name = "amazon_sync_logs", schema_name = "vault")]
    pub struct Model {
        #[sea_orm(primary_key)]
        pub id: i64,
        pub tenant_id: Uuid,
...
pub struct AmazonSyncLogRepo {
    db: DatabaseConnection,
}

impl AmazonSyncLogRepo {
    ...
    pub async fn log_sync_start(
        ...
        use amazon_sync_log_entity as entity;
    ...
    pub async fn log_sync_success(
        ...
        active.amazon_id = Set(amazon_id);

...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        let exists = db.query_one_raw(sea_orm::Statement::from_sql_and_values(
        ...
        let stmt = sea_orm::Statement::from_sql_and_values(
            ...
            vec![
                ...
                serde_json::to_value(&trigger).unwrap_or(serde_json::Value::Null).into(),
                serde_json::to_value(&conditions).unwrap_or(serde_json::Value::Null).into(),
                serde_json::to_value(&actions).unwrap_or(serde_json::Value::Null).into(),
                true.into(),
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        let db = manager.get_connection();
        let delete_sql = "DELETE FROM collab_crm.workflows WHERE id = '11111111-1111-1111-1111-111111111111'";

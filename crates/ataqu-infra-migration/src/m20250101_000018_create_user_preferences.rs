...
impl MigrationTrait for Migration {
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Alias::new("last_read_changelog_at")).timestamp_with_time_zone())
                    .col(ColumnDef::new(Alias::new("preferences")).json_binary().not_null().default(Expr::cust("'{}'")))
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .drop_table(Table::drop().table((Alias::new("core"), Alias::new("user_preferences"))).to_owned())
            .await
    }
}
